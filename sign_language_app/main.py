...
mediapipe_model = load_model('/home/ashik/luminar_python/sign_language_detection_project/web_app/action.h5')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/ashik/luminar_python/sign_language_detection_project/web_app/last.pt', help='model.pt path(s)')
